export const chapter3 = { id:'chapter3', title:'岐路', chapter:'第三章　2日目・夜', nodes:[
 ...
 {t:'chara',id:'chara_goko',expr:'grim',pos:'left',action:'fadeIn'}, {t:'say',who:'goko',text:'……食えよ、みんな。毒見なら俺がしてやる。ほら、こうして食って見せりゃいいんだろ。'},
 ...
 {t:'chara',id:'chara_fujino',expr:'uneasy',pos:'right',action:'fadeIn'}, {t:'say',who:'fujino',text:'ねえ……もう、やめない？　兄さんも死んだのよ。誰がこんなこと――。'},
 {t:'stage',text:'【藤乃、スプーンを持つ手が震えている。スープの表面に小さな輪が幾つも重なる。】'},
 {t:'say',who:'fujino',text:'私たち、何を約束したの。何をしたら終わるって言われたの。紙に書かれていたからって、あれを信じて……。'},
 {t:'chara',id:'chara_makabe',expr:'uneasy',pos:'center',action:'fadeIn'}, {t:'say',who:'makabe',text:'藤乃さん。……食事にしましょう。今ここで言葉を足しても、警察の代わりにはなりません。'},
