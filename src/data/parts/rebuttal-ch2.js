export const rebuttalCh2 = { id:'day2_inquiry', title:'二日目昼の尋問', initialConviction:52, nodes:[
 {id:'n1', kind:'前提', type:'前提', designIntent:'正しい知識を使うと死ぬ。「知らないフリ」の基本文法を教える。', claim:'毒は夜食の珈琲に混入された', responses:[
  ...
  {kind:'rebut',label:'毒は寝酒の方では？',note:'詳細を知りすぎる危険な切り返し',result:{effects:[{t:'param',key:'conviction',delta:-15},{t:'param',key:'overknow',delta:1},{t:'param',key:'suspicion',delta:15}],overknow:true,note:'悟郎の前提を崩した瞬間、コウナンの視線がこちらへ向く。'}},
 ...
 {id:'n3', kind:'物証', type:'物証', designIntent:'N2の成否が沈黙の意味を変える連鎖を見せる。', claim:'カップに残った、あんたの指紋', responses:[
  ...
  {kind:'rebut',label:'手袋をしていれば指紋など…',result:{effects:[{t:'param',key:'conviction',delta:-14},{t:'param',key:'overknow',delta:1},{t:'param',key:'suspicion',delta:10}],overknow:true,note:'指紋の前提は崩せたが、犯人の手口に詳しすぎる。'}},
