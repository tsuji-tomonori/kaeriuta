export const rebuttalCh2 = { id:'day2_inquiry', title:'二日目昼の尋問', initialConviction:52, nodes:[
 {id:'n1', kind:'前提', type:'前提', designIntent:'正しい知識を使うと死ぬ。「知らないフリ」の基本文法を教える。', claim:'毒は夜食の珈琲に混入された', responses:[
  ...
  {kind:'rebut',label:'毒は寝酒の方では？',result:{effects:[{t:'param',key:'overknow',delta:1},{t:'param',key:'suspicion',delta:15}],overknow:true,note:'コナン「…お姉さん、なんでそう思うの？」'}},
 ...
 {id:'n2', kind:'論理', type:'論理', designIntent:'日常の選択で拾った弾と、人間関係に残る代償を示す。', claim:'珈琲を淹れて運べたのは、厨房にいた栞さんだけ', responses:[
  ...
  {kind:'redirect',label:'剛蔵兄さんが後からポットに近づいた',cond:{flag:'other_plan'},result:{effects:[{t:'param',key:'conviction',delta:-20},{t:'param',key:'trust',delta:-1}],break:true,note:'成功。ただし共犯者を売った。'}},
 ...
 {id:'n3', kind:'物証', type:'物証', designIntent:'N2の成否が沈黙の意味を変える連鎖を見せる。', claim:'カップに残った、あんたの指紋', responses:[
  ...
  {kind:'silence',label:'沈黙する',result:{effects:[{t:'param',key:'conviction',delta:15}],conditional:{ifBroken:'n2',effects:[]},note:'N2撃破済みなら小五郎が自壊する。'}}]}
